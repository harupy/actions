...
function acquireRUbuntu(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield exec.exec("sudo DEBIAN_FRONTEND=noninteractive add-apt-repository -y ppa:cran/travis || true");
            yield exec.exec("sudo DEBIAN_FRONTEND=noninteractive apt-get update -qq || true");
